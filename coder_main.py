...
class Coder(tk.Frame):
    ...
    def __init__(self, parent):
        ...
        self.btn25.grid(row=5, column=3)
        self.btn26 = tk.Button(self.f2, text="send2 view4", bg="orange",bd=8, command=self.sendcode2)
        self.btn26.grid(row=6, column=4)
        self.btn27 = tk.Button(self.f2, text="semdcode to tab4", bg="orange",bd=6, command=self.sendcode3)
        self.btn27.grid(row=7, column=5)
        self.btn28 = tk.Button(self.f2, text="to toplevel from tab4-", bg="orange", bd=6,command=self.sendcode4)
        self.btn28.grid(row=8, column=5)
...
##        self.but39.grid(row=17, column=3)
        ...
        self.txt4.grid(row=0, column=2,sticky="nsew")
    ...
    def sendcode2(self):
        text = self.txt4.get("1.0", tk.END)
        self.view.txx.insert(tk.END, text)
        
    def sendcode3(self):
        
        text = self.view.txx.get("1.0", tk.END)
        self.txt4.insert(tk.END,text)
